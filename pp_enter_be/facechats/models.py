...
class FaceChat(models.Model):
    ...
    host_id = models.ForeignKey(
        settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name="hosted_chats"
    )
...
class FaceChatParticipant(models.Model):
    face_chat_id = models.ForeignKey(
        FaceChat, on_delete=models.CASCADE, related_name="participants"
    )
...
class FaceChatTag(models.Model):
    face_chat_id = models.ForeignKey(
        "FaceChat", on_delete=models.CASCADE, related_name="tags"
    )
